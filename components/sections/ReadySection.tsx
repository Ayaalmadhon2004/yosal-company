      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 text-right">
            ...
            {/* زر الواتساب المخصص */}
            <button className="bg-[#25D366] hover:bg-[#20bd5a] text-white px-10 py-5 rounded-2xl text-lg font-bold flex items-center gap-4 transition-all duration-300 hover:scale-105 shadow-xl shadow-green-500/20 active:scale-95">
