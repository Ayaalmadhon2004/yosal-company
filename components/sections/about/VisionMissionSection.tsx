...
// المكون الرئيسي - التصدير الافتراضي الوحيد في الملف
export default function VisionMissionSection() {
  return (
    <section className="py-24 bg-[#0a0d1d] text-right" dir="rtl">
      <div className="container mx-auto px-6">
        
        {/* الحاوية الرئيسية للكروت (الرؤية والرسالة) */}
        <div className="flex flex-col lg:flex-row gap-8 mb-20">
          
          {/* كرت رسالتنا - خلفية برتقالية */}
          ...
          {/* كرت رؤيتنا - خلفية داكنة مع حافة برتقالية */}
